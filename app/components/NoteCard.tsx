  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5 hover:shadow-lg transition-all duration-200 flex flex-col group">
      <div className="flex justify-between items-start mb-3">
        <h3 className="font-semibold text-lg text-card-foreground line-clamp-1 break-all">{note.title || "Untitled Note"}</h3>
      ...
      <p className="text-gray-500 text-sm flex-1 whitespace-pre-wrap line-clamp-4 leading-relaxed break-words">
        {note.content}
      </p>
