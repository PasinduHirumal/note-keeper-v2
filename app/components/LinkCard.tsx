    ...
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center space-x-3 pr-4 overflow-hidden">
          ...
          <h3 className="font-medium text-card-foreground truncate">{link.title || domain}</h3>
        </div>
        <div className="flex flex-col items-end shrink-0 ml-2">
          <button 
            ...
            className="p-1.5 text-gray-500 hover:text-red-500 rounded-md transition-colors opacity-100 sm:opacity-0 sm:group-hover:opacity-100 shrink-0 bg-transparent sm:bg-card/80 backdrop-blur-sm" 
            title="Delete link"
          >
